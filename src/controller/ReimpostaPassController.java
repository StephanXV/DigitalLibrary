...
//import static controller.LoginController.getEmail;
...
public class ReimpostaPassController {
    ...
    void initialize() throws SQLException {
        domanda = getDomandaSicurezza(em).get(0);
        risposta = getDomandaSicurezza(em).get(1);
    ...
    void savefired(ActionEvent event){
        try {
            ...
            updateProfilo(em, "pass", nuovaPass.getText());
