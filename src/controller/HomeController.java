...
public class HomeController {
    ...
    void initialize(){
        ...
        loadContent("/view/Presentation.fxml");
    }
    ...
    @FXML
    void profiloButtonFired(ActionEvent event) { loadContent("/view/VisualizzaProfilo.fxml"); }

    @FXML
    void acquisizioneButtonFired(ActionEvent event){ loadContent("/view/UploadOpera.fxml");}

    @FXML
    void pubOperaFired(ActionEvent event){ loadContent("/view/PubblicaOpera.fxml");}

    @FXML
    void insOperaButtonFired(ActionEvent event){ loadContent("/view/InserisciOpera.fxml");}

    @FXML
    void trascrizioneButtonFired(ActionEvent event){ loadContent("/view/Trascrizione.fxml");}

    @FXML
    void revAcquisizioniButtonFired(ActionEvent event){loadContent("/view/Convalida.fxml");}

    @FXML
    void assTrascrizioniButtonFired(ActionEvent event){loadContent("/view/AssegnaTrascrizioni.fxml");}

    @FXML
    void assExpButtonFired(ActionEvent event){
        loadContent("/view/AssegnaEsperienza.fxml");
    }

    @FXML
    void adminButtonFired(ActionEvent event){loadContent("/view/GestionePrivilegi.fxml");}
    ...
    void cercaOperaIsFired(ActionEvent event){
    	...
    	text=cerca.getText();
    	loadContent("/view/RicercaOpera.fxml");
