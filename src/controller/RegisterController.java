...
import static DAO.UtenteDAO.confrontaEmail;
import static DAO.UtenteDAO.registrazione;
...
public class RegisterController {
    ...
    void  registerButtonFired(ActionEvent event){
        try {
            ...
            if (confrontaEmail(emailField.getText())) {
            ...
            if(nomeError.getText().equals("")&&cognomeError.getText().equals("")&&emailError.getText().equals("")
                ...
                if (femaleCheck.isSelected()) {
                    registrazione(nomeField.getText(), cognomeField.getText(), parseData, emailField.getText(),
