...
public class ModificaProfiloController {
    ...
    @FXML
    private Label text;
    private UtenteBase u = getUtente();
    ...
    void initialize() throws SQLException {
        ...
        domPR1.setPromptText(getDomanda(u.getEmail()).get(0));
        rispPR1.setPromptText(getDomanda(u.getEmail()).get(1));
    }

    @FXML
    void buttModNome(ActionEvent event) throws SQLException { updateProf(u.getEmail(),"nome",nomePR1.getText()); u.setNome(nomePR1.getText()); updateUtente();}
    @FXML
    void buttModCognome(ActionEvent event) throws SQLException { updateProf(u.getEmail(),"cognome",cognomePR1.getText()); u.setCognome(cognomePR1.getText()); updateUtente();}
    @FXML
    void buttModEmail(ActionEvent event) throws SQLException { updateProf(u.getEmail(),"email",emailPR1.getText()); u.setEmail(emailPR1.getText()); updateUtente();}
    @FXML
    void buttModPass(ActionEvent event) throws SQLException { updateProf(u.getEmail(),"pass",passPR1.getText()); u.setPass(passPR1.getText()); updateUtente();}
    @FXML
    void buttModDom(ActionEvent event) throws SQLException { updateProf(u.getEmail(),"domanda_sicurezza",(String)domPR1.getValue()); updateUtente();}
    @FXML
    void buttModRisp(ActionEvent event) throws SQLException { updateProf(u.getEmail(),"risposta_sicurezza",rispPR1.getText()); updateUtente();}
    @FXML
    void buttModSex(ActionEvent event) throws SQLException { updateProf(u.getEmail(),"sesso",(String)sessoPR1.getValue()); u.setSesso((String)sessoPR1.getValue()); updateUtente(); if (((String)sessoPR1.getValue()).equals("M")){ imageProf1.setImage(new Image("/view/icons/iconfinder_3_avatar_2754579.png"));}
    else if (((String)sessoPR1.getValue()).equals("F")) { imageProf1.setImage(new Image ("view/icons/iconfinder_9_avatar_2754584.png"));}}
    @FXML
    void buttModNasc(ActionEvent event) throws SQLException { updateProf(u.getEmail(),"data_nascita",nascPR1.getText()); u.setData_nascita(nascPR1.getText()); updateUtente();}
    @FXML
    ...
    private void textClick(MouseEvent event) throws SQLException, IOException {
        ...
        fxmlLoader.setLocation(getClass().getResource("/view/fxml/RichiediPermesso.fxml"));
