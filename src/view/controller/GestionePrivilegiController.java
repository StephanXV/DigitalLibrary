...
import static controller.UtenteController.convalidaPermessi;
import static controller.UtenteController.permessiAttesa;
...
public class GestionePrivilegiController extends ListView<String> {
    ...
    void initialize() throws SQLException {
        list.clear();
        list1.clear();
        TreeMap<String,String> mappa = permessiAttesa();
    ...
    public void buttonPriv1(ActionEvent event) throws SQLException {
        ...
        convalidaPermessi(email.get(0), list1.get(i), messaggio);
        initialize();
    }
