...
import static controller.UtenteController.permessi;
...
public class RichiediPermessoController {
    ...
    void bottonePermesso(ActionEvent event) throws SQLException {
        String www = getUtente().getEmail();
        String xy = (String) permessoR.getValue();
        if(checkPerm(www,xy) == 0) {permessi(www,xy); labelPermesso.setTextFill(Color.web("#4bc436")); labelPermesso.setText("Privilegio richiesto con successo!");}
